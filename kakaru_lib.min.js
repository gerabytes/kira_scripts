...
if(it.type=="function"&&it.stateMutability=="nonpayable"){_r[it.name+""]=function(...args){return _r._contract.methods[it.name](...args).send({from:k.connectedAddress});}}
if(it.type=="function"&&it.stateMutability=="payable"){_r[it.name+""]=function(...args){var vargs=JSON.parse(JSON.stringify(args));console.log(vargs);var _v=vargs.splice(-1);if(Array.isArray(_v))_v=_v[0];console.log(_v);return _r._contract.methods[it.name](...vargs).send({from:k.connectedAddress,value:_v});}}});return _r;};window.setTimeout(()=>{if(window.Web3==undefined){var el=document.createElement("script"),loaded=false;el.onload=el.onreadystatechange=function(){if((el.readyState&&el.readyState!=="complete"&&el.readyState!=="loaded")||loaded){return false;}
...
window.kakaru_contracts={
    "_self_contract_":"DKSTokenSaleWhitelistCliffVesting",
    "0x32bED61c11d1E6637c014F7CC986DC017B9b502D":"DKSTokenSaleWhitelistCliffVesting",
    "0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56":"Erc20",
    "0xa23D46Ec326cc072dBf74c8182d67bf7C971fBdB":"Erc20"
}
